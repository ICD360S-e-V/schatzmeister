; ICD360S e.V - Schatzmeister Portal Installer
; Inno Setup Script

#define MyAppName "ICD360S e.V - Schatzmeister"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "ICD360S e.V"
#define MyAppURL "https://icd360sev.icd360s.de"
#define MyAppExeName "ICD360S_eV.exe"
#define MyAppId "{{B6F7C3D4-A0E2-5F8B-C9D1-E2F3A4B5C6D7}"
...
AppUpdatesURL={#MyAppURL}/downloads/schatzmeister/windows/
...
OutputBaseFilename=icd360sev_schatzmeister_setup
...
VersionInfoDescription=ICD360S e.V Schatzmeister Portal
VersionInfoProductName={#MyAppName}
VersionInfoProductVersion={#MyAppVersion}
VersionInfoOriginalFileName=icd360sev_schatzmeister_setup.exe
