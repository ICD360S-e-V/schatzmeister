          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _buildInfoRow(Icons.check_circle, l.anonymousStats),
                  const SizedBox(height: 8),
                  _buildInfoRow(Icons.check_circle, l.errorReports),
                  const SizedBox(height: 8),
                  _buildInfoRow(Icons.check_circle, l.performanceData),
                ],
              ),
            ),
            const SizedBox(height: 16),
