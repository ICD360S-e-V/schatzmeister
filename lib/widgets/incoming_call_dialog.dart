...
class _InCallOverlayState extends State<InCallOverlay> with SingleTickerProviderStateMixin {
  ...
  Widget _buildNetworkQualityIndicator(AppLocalizations l) {
    ...
    switch (widget.iceConnectionState!) {
      ...
      case RTCIceConnectionState.RTCIceConnectionStateCompleted:
        ...
        color = Colors.green;
        tooltip = l.connectionExcellent;
        break;
      case RTCIceConnectionState.RTCIceConnectionStateChecking:
        icon = Icons.signal_cellular_alt_2_bar;
        color = Colors.orange;
        tooltip = l.connectionConnecting;
        break;
      case RTCIceConnectionState.RTCIceConnectionStateDisconnected:
        icon = Icons.signal_cellular_alt_1_bar;
        color = Colors.red;
        tooltip = l.connectionDisconnected;
        break;
      case RTCIceConnectionState.RTCIceConnectionStateFailed:
        icon = Icons.signal_cellular_off;
        color = Colors.red;
        tooltip = l.connectionFailed;
        break;
      default:
        icon = Icons.signal_cellular_alt_1_bar;
        color = Colors.grey;
        tooltip = l.connectionUnknown;
    }
