...
/// Helper function to get label for document type (localized)
String getDokumentTypLabel(String typ, {BuildContext? context}) {
  if (context != null) {
    final l = AppLocalizations.of(context);
    switch (typ) {
      case 'urkunde': return l.documentUrkunde;
      case 'vollmacht': return l.documentVollmacht;
      case 'satzung': return l.documentSatzung;
      case 'protokoll': return l.documentProtokoll;
      case 'antrag': return l.documentAntrag;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (rechnungen.isNotEmpty)
                        Text(
                          l.invoicesSummary(rechnungen.length, totalBetrag.toStringAsFixed(2), unbezahltCount),
                          style: TextStyle(fontSize: 12, color: Colors.grey.shade600),
                        ),
                    ],
                  ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (besuche.isNotEmpty)
                        Text(
                          l.visitsSummary(besuche.length, geplant),
                          style: TextStyle(fontSize: 12, color: Colors.grey.shade600),
                        ),
                    ],
                  ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (dokumente.isNotEmpty)
                        Text(
                          l.nDocumentsLabel(dokumente.length),
                          style: TextStyle(fontSize: 12, color: Colors.grey.shade600),
                        ),
                    ],
                  ),
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              subtitle: Text(
                                '${d['datum'] ?? ''} • ${getDokumentTypLabel(typ, context: context)}',
                                style: TextStyle(fontSize: 11, color: Colors.grey.shade600),
                              ),
                            );
                          },
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (aufgaben.isNotEmpty)
                        Text(
                          l.tasksSummary(aufgaben.length, offenCount),
                          style: TextStyle(fontSize: 12, color: Colors.grey.shade600),
                        ),
                    ],
                  ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (zahlungen.isNotEmpty)
                        Text(
                          l.paymentsSummary(zahlungen.length, totalZahlungen.toStringAsFixed(2)),
                          style: TextStyle(fontSize: 12, color: Colors.grey.shade600),
                        ),
                    ],
                  ),
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              title: Text(
                                z['verwendungszweck'] ?? l.paymentLabel,
                                style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w500),
                                overflow: TextOverflow.ellipsis,
                              ),
                              subtitle: Text(
