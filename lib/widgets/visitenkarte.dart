...
class _VisitenkarteState extends State<Visitenkarte> {
  ...
  String _getRoleText(AppLocalizations loc) {
    switch (_role) {
      case 'vorsitzer':
        return loc.roleVorsitzer;
      case 'schatzmeister':
        return loc.roleSchatzmeister;
      case 'kassierer':
        return loc.roleKassierer;
      case 'mitgliedergrunder':
        return loc.foundingMember;
      default:
        return _role;
    }
  }
  ...
  Widget _buildRuckseite(AppLocalizations loc) {
    return Container(
