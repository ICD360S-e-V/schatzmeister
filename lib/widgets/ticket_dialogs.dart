...
class _TicketsListDialogState extends State<_TicketsListDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: Row(
        children: [
          const Icon(Icons.confirmation_number, color: Color(0xFF4a90d9)),
            ...
            children: [
              Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      l.priorityLabel(ticket.priorityDisplay),
                      style: TextStyle(
                        color: _getPriorityColor(ticket.priority),
                        fontWeight: FontWeight.w500,
                      ),
              ...
              Row(
                children: [
                  ...
                  Text(
                    l.createdLabel(_formatDate(ticket.createdAt)),
              ...
              if (ticket.adminName != null) ...[
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 6),
                    Text(
                      l.processorLabel(ticket.adminName!),
                      style: TextStyle(color: Colors.grey.shade600, fontSize: 13),
                    ),
                  ],
                ),
  ...
  Future<void> _submitTicket() async {
    ...
    if (subject.isEmpty || message.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(l.pleaseFillSubjectAndMessage),
    ...
    if (result.containsKey('ticket')) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(result['error'] ?? l.errorCreatingTicket),
...
class _AdminCreateTicketDialogState extends State<_AdminCreateTicketDialog> {
  ...
  Future<void> _submitTicket() async {
    ...
    if (_selectedMember == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(l.pleaseSelectMember),
          backgroundColor: Colors.orange,
        ),
      );
      return;
    ...
    if (result.containsKey('ticket')) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(l.ticketCreatedFor(_selectedMember!.name)),
          backgroundColor: Colors.green,
        ),
      );
      Navigator.pop(context, true);
