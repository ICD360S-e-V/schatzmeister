...
class _TicketverwaltungScreenState extends State<TicketverwaltungScreen> {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              if (widget.ticketStats != null) ...[
                _buildStatBadge(l.total, widget.ticketStats!.total, Colors.blue),
                const SizedBox(width: 6),
                _buildStatBadge(l.statusOpen, widget.ticketStats!.open, Colors.orange),
                const SizedBox(width: 6),
                _buildStatBadge(l.completed, widget.ticketStats!.done, Colors.green),
              ],
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: [
              _buildTicketFilterChip(l.all, 'all'),
              _buildTicketFilterChip(l.statusOpen, 'open'),
              _buildTicketFilterChip(l.inProgress, 'in_progress'),
              _buildTicketFilterChip(l.waitingMember, 'waiting_member'),
              _buildTicketFilterChip(l.waitingStaff, 'waiting_staff'),
              _buildTicketFilterChip(l.waitingAuthority, 'waiting_authority'),
              _buildTicketFilterChip(l.waitingDocuments, 'waiting_documents'),
              _buildTicketFilterChip(l.completed, 'done'),
            ],
          ),
          const SizedBox(height: 16),
          // Week navigation
  ...
  Widget _buildWeeklyGrid() {
    final l = AppLocalizations.of(context);
    final dayNames = [l.monday, l.tuesday, l.wednesday, l.thursday, l.friday];
    return Card(
      elevation: 2,
      child: Column(
        children: [
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    l.nTickets(todayTickets.length),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: Text(
                            ticket.memberName ?? AppLocalizations.of(context).unknown,
                            style: TextStyle(
                              color: isPast ? Colors.grey.shade400 : Colors.grey.shade600,
                              fontSize: 12,
                            ),
