...
class VerwarnungService {
  ...
  Future<Verwarnung?> createVerwarnung({
    ...
    try {
      ...
      final response = await _client.post(
        Uri.parse('$baseUrl/schatzmeister/verwarnungen_create.php'),
        headers: _headers,
  ...
  Future<({List<Verwarnung> warnings, VerwarnungStats stats})?> getVerwarnungen(int userId) async {
    try {
      final response = await _client.get(
        Uri.parse('$baseUrl/schatzmeister/verwarnungen_list.php?user_id=$userId'),
        headers: _headers,
      );
  ...
  Future<bool> deleteVerwarnung(int id) async {
    try {
      final response = await _client.post(
        Uri.parse('$baseUrl/schatzmeister/verwarnungen_delete.php'),
        headers: _headers,
