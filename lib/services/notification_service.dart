...
class NotificationService {
  ...
  static final MethodChannel _macOSChannel =
      MethodChannel('de.icd360sev.schatzmeister/notifications');
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      // Create notification channel for Android + request runtime permission (Android 13+)
  ...
  Future<void> _requestAndroidPermission() async {
    ...
    if (androidImpl != null) {
      ...
      _log.info('Android POST_NOTIFICATIONS permission: ${granted == true ? "granted" : "denied"}', tag: 'NOTIF');
    }
  }
