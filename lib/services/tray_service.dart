...
class TrayService with TrayListener {
  ...
  /// Currently only Windows has tray icons (ICO format)
  ...
  /// TrayListener: Handle right click on tray icon
  @override
  void onTrayIconRightMouseDown() {
    _trayManager.popUpContextMenu();
  }

  /// TrayListener: Handle context menu item click
  @override
  ...
  Future<void> updateUnreadCount(int count) async {
    ...
    try {
      ...
      await _trayManager.setIcon(trayIconPath);
