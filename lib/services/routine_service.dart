...
class RoutineService {
  ...
  Future<List<Routine>> getRoutines({int? userId, String? category, bool activeOnly = true}) async {
    try {
      ...
      final uri = Uri.parse('$baseUrl/schatzmeister/routine_list.php').replace(queryParameters: params);
  ...
  Future<RoutineStats?> getRoutineStats() async {
    try {
      final uri = Uri.parse('$baseUrl/schatzmeister/routine_list.php?active_only=1');
      final response = await _client.get(uri, headers: _headers);
  ...
  Future<Routine?> createRoutine({
    ...
    try {
      ...
      final response = await _client.post(
        Uri.parse('$baseUrl/schatzmeister/routine_create.php'),
        headers: _headers,
  ...
  Future<Routine?> updateRoutine(int routineId, Map<String, dynamic> fields) async {
    try {
      ...
      final response = await _client.post(
        Uri.parse('$baseUrl/schatzmeister/routine_update.php'),
        headers: _headers,
        body: jsonEncode(body),
      );
  ...
  Future<bool> deleteRoutine(int routineId) async {
    try {
      final response = await _client.post(
        Uri.parse('$baseUrl/schatzmeister/routine_delete.php'),
        headers: _headers,
  ...
  Future<({List<RoutineExecution> executions, ExecutionStats? stats})> getExecutions({
    ...
    try {
      ...
      final uri = Uri.parse('$baseUrl/schatzmeister/routine_executions.php').replace(queryParameters: params);
      final response = await _client.get(uri, headers: _headers);
  ...
  Future<bool> updateExecution({
    ...
    try {
      ...
      final response = await _client.post(
        Uri.parse('$baseUrl/schatzmeister/routine_executions.php'),
        headers: _headers,
        body: jsonEncode(body),
      );
      final data = jsonDecode(response.body);
